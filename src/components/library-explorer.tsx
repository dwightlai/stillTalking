  ...
  return (
    <div>
      ...
      <div className="library-summary">
        <strong>{filtered.length}</strong> practical articles
      ...
      <style>{`
        ...
        .library-summary { color:var(--muted); margin-bottom:30px; }
        ...
        .card-meta { display:flex; gap:12px; color:var(--muted); font-size:11px; margin-top:11px; }
